# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-05-10 18:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Punch',
            fields=[
                ('id_punch', models.UUIDField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Rapper',
            fields=[
                ('id_rapper', models.UUIDField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Season',
            fields=[
                ('id_season', models.UUIDField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),

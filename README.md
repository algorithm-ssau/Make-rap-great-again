...
Мы разместили наш сайт на бесплатном хостинге Heroku. Для этого нам понадобилось зарегистрироваться на сайте, установить приложение, и далее
Поэтому вы можите просто перейти по ссылке:
